...
class MainWindow(QMainWindow):
    ...
    def start_test(self):
        ...
        self.x_data.clear()
        self.y_data.clear()
        self.ppk2_test.use_ampere_meter()  # set ampermeter meter mode
        self.ppk2_test.toggle_DUT_power("OFF")  # diable DUT power
