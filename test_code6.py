...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.plotTimer.setInterval(10)  # Update every 10 ms
    ...
    def update_plot(self):
        ...
        if read_data != b'':
            ...
            # Şu anki zamanın zaman damgasını al
            current_time = time.localtime()

            print(current_time.tm_hour,current_time.tm_min,current_time.tm_sec,self.y_data[-1],len(samples))
        ...
        if self.secondTime==int(self.x_data[-1]+(self.worktime)):
            ...
            if self.join>40000 and self.avgValue<5:
    ...
    def update_text(self):
        ...
        if self.isTestStarted:
            ...
            if len(self.yatayKonum1) > 1:
                ...
                if 3 > self.yatayKonum1[-1] > 1.9 and self.yatayKonum1[-1] - self.dikKonum1[-1] >= 0.3:
            ...
            if len(self.dikKonum2) > 1:
                ...
                if 3 > self.dikKonum2[-1] > 1.9 and self.yatayKonum1[-1] - self.dikKonum2[-1] >= 0.3:
            ...
            if len(self.yatayKonum2) > 1:
                ...
                if 3 > self.yatayKonum2[-1] > 1.9 and self.yatayKonum2[-1] - self.dikKonum2[-1] >= 0.3:
            ...
            if len(self.dikKonum3) > 1:
                ...
                if 3 > self.dikKonum3[-1] > 1.9 and self.yatayKonum2[-1] - self.dikKonum3[-1] >= 0.3:
            ...
            if len(self.yatayKonum3) > 1:
                ...
                if 3 > self.yatayKonum3[-1] > 1.9 and self.yatayKonum3[-1] - self.dikKonum3[-1] >= 0.3:
            ...
            if len(self.yatayKonumOrt) != 0:
                ...
                if 3 > yatayKonumOrtValue > 1.9 and yatayKonumOrtValue - dikKonumOrtValue >= 0.3:
